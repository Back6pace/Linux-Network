...
`sudo dhclient -r`<br>
-r - явно освобождает текущую аренду ip адреса.<br>
![Alt text](img/25.png)
...
Проверяем соединение между ws22 и r1<br>
`ping -c 5 10.100.0.11`
![Alt text](img/38.png)
...
![Alt text](img/54.png)
Для проверки, сработало ли подключение вводим команду `telnet 127.0.0.1 [локальный порт]`. В момент выполнения данной команды необходимо нажать любую клавишу
![Alt text](img/55.png)
##### Сохранить дампы образов виртуальных машин
**p.s. Ни в коем случае не сохранять дампы в гит!**